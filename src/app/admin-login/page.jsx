                    ...
                    <div className="flex-1 flex flex-col justify-center max-w-md w-full mx-auto">
                        ...
                        <div className="mt-8 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <Button variant="outline" className="h-12 rounded-full border-muted-foreground/20 hover:bg-muted/50">
                                ...
                                <Button variant="outline" className="h-12 rounded-full border-muted-foreground/20 hover:bg-muted/50">
                                    <svg className="mr-2 h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M12.152 6.896c-.548 0-1.411.516-1.411 1.304 0 .914.714 1.329 1.444 1.329.548 0 1.412-.514 1.412-1.304 0-.914-.714-1.329-1.445-1.329zm.41 3.666c-2.12 0-3.636 1.27-3.636 3.333 0 2.44 2.15 3.334 3.636 3.334 2.12 0 3.636-1.27 3.636-3.334 0-2.44-2.15-3.333-3.636-3.333zm-1.21 2.708c-.548 0-1.411.515-1.411 1.304 0 .914.714 1.329 1.444 1.329.548 0 1.412-.515 1.412-1.304 0-.914-.714-1.329-1.445-1.329z" />
